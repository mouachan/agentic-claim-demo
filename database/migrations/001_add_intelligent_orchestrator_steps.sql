-- Migration: Add intelligent orchestrator step names to processing_step ENUM
-- Date: 2025-12-24
-- Description: Adds tool names used by the intelligent orchestrator to the processing_step ENUM
